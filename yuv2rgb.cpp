...
bool nv12_to_rgb(unsigned char* rgb, unsigned char const* nv12, int width, int height) {
    return decode_yuv<NV21toRGB>(rgb, nv12, width, height);
}
//------------------------------------------------------------------------------
class NV21toRGBA {
public:
...
bool nv12_to_rgba(unsigned char* rgba, unsigned char alpha, unsigned char const* nv21, int width, int height) {
